package Java.src.Games.TickTackToe;
...
public class TicTacToe {
	...
	public static void main(String[] args) {
		...
		/**
		 * Aqu� creamos el tablero de juego en blanco
		 */
		char[][] gameBoard = {{' ', '|',' ','|',' '},
						{'-', '+','-','+','-'},
						{' ', '|',' ','|',' '},
		...
		/**
		 * Aqu� es donde se llevara acabo el juego. Tenemos el while que nos dejara jugar hasta un break.
		 */
		while(true)
		{
	...
	/**
	 * Este metodo imprime el tablero de juego. 
	...
	/**
	 * 
	 * Este m�todo coloca en una posici�n elegida por el jugador o por la computadora
	 * en el lugar elegido. El jugador le corresponde el caracter X y a la computadora el O.
	 * 
	 * @param gameBoard. El parametro es un array de tipo Char bidimensional. El array es creado anteriormente
	 * @param pos. Este parametro es un int entre 1-9 que nos da la posici�n en la que se quiere hacer una jugada.
	...
	/**
	 * Este metodo nos devuelve el quien gano durante el juego o si hubo un empate. 
